...
class GameApp(models.Model):
    ...
    desc = models.TextField(db_column='memo',max_length=4000)
    author_name = models.CharField(max_length=100,db_column='developer')
    category_name = models.CharField(max_length=50,db_column='categoryname')
